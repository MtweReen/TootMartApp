    ...
    return BlocConsumer<CheckOutCubit, CheckOutStates>(
      ...
      builder: (context, state) {
        ...
        return ConditionalBuilder(
          condition: state is! GetOrderDetailLoadingState || CheckOutCubit.get(context).orderModel != null,
                  ...
                  child: Column(
                    children: [
                      ...
                      physics: const NeverScrollableScrollPhysics(),
                          children: [
                            CurrentOrders(orders: CheckOutCubit.get(context).orderModel!.body!.ordersUnderProcess!,),
                            FinishedOrders(order: CheckOutCubit.get(context).orderModel!.body!.ordersCompleted!,),
                          ],
                        ),
                      ),
